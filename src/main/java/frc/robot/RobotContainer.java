...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        // joystick.pov(0).and(joystick.y()).whileTrue(drivetrain.sysIdDynamic(Direction.kForward));
        // joystick.pov(180).and(joystick.x()).whileTrue(drivetrain.sysIdDynamic(Direction.kReverse));
